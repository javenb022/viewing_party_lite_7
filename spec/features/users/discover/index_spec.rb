...
describe "Discover Index Page" do
  ...
  xit "should take the user to the movies results page from the Discover Top Movies button" do 
    click_button "Discover Top Rated Movies"
    expect(page).to have_current_path("/users/#{@user_1.id}/movies")
  end

  xit "should take the user to the movies results page from the Search button" do
    click_button "Search"
    expect(page).to have_current_path("/users/#{@user_1.id}/movies")
  end
end